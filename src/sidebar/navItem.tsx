        ...
        <div className="w-full flex flex-wrap justify-end items-center">
          ...
          {navLink.childLinks?.map((child, index) => (
            <Link
              ...
              className={`navLink w-full mt-1 p-2 flex flex-wrap items-center h-fit hover:bg-blue-900 hover:text-white rounded-md justify-end ${
            ...
            >
              ...
              <span className="flex justify-start items-center w-5/6 tracking-widest text-sm">
                {child.name}
              </span>
            </Link>
          ))}
